...
export const mockData: DataItem[] = [
  {
    ...
    Rating: 9,
    Logo: 'https://robohash.org/voluptatemvoluptatequi.bmp?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/5fa2dd/ffffff',
  },
  {
    Name: 'Zathin',
    Description:
    ...
    Rating: 7,
    Logo: 'https://robohash.org/undedeseruntinventore.jpg?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/5fa2dd/ffffff',
  },
  {
    Name: 'Lotstring',
    ...
    Rating: 6,
    Logo:
      'https://robohash.org/inventoreullamconsequatur.bmp?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/dddddd/000000',
  },
  {
    Name: 'Bitwolf',
    Description:
    ...
    Rating: 2,
    Logo: 'https://robohash.org/harumquisuscipit.bmp?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/cc0000/ffffff',
  },
  {
    Name: 'Voltsillam',
    Description:
    ...
    Rating: 3,
    Logo:
      'https://robohash.org/nostrummolestiaecorporis.png?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/5fa2dd/ffffff',
  },
  {
    Name: 'Overhold',
    ...
    Rating: 5,
    Logo: 'https://robohash.org/utrerumsit.png?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/ff4444/ffffff',
  },
  {
    Name: 'Gembucket',
    Description:
    ...
    Rating: 2,
    Logo: 'https://robohash.org/rationeeaquemolestias.png?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/5fa2dd/ffffff',
  },
  {
    Name: 'Andalax',
    ...
    Rating: 4,
    Logo: 'https://robohash.org/sequimagnamquae.bmp?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/cc0000/ffffff',
  },
  {
    Name: 'Otcom',
    ...
    Rating: 7,
    Logo: 'https://robohash.org/doloremquequidematque.png?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/dddddd/000000',
  },
  {
    Name: 'Sonsing',
    ...
    Rating: 5,
    Logo: 'https://robohash.org/inaperiamquaerat.png?size=50x50&set=set1',
    Img: 'https://dummyimage.com/600x300.jpg/5fa2dd/ffffff',
  },
]
